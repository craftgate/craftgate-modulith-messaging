...
import io.craftgate.modulith.messaging.test.integration.sample.rollbackunchained.infra.rest.CreateUserRequest;
import io.craftgate.modulith.messaging.test.integration.sample.rollbackunchained.infra.rest.UserDto;
...
public class RollbackUnchainedIT extends AbstractIT {
    ...
    @Test
    void should_create_user_when_unchained_bcx_has_failing_transaction() throws InterruptedException {
        // given
        ...
        Thread.sleep(1000); // just wait to see the logs
